...
# On définit le HTML directement ici pour éviter l'erreur de dossier manquant
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <div class="w-full max-w-md bg-[#171f2f] rounded-3xl shadow-2xl p-6 border border-slate-800">
        ...
        <div class="mt-8 space-y-3">
            ...
            <div class="bg-[#1e293b] p-3 rounded-xl border border-slate-700">
                ...
                <p class="text-xs text-white">Prix : <span class="text-green-400 font-bold">{{ item.prix }}</span></p>
            </div>
            {% endfor %}
        </div>
        {% endif %}
